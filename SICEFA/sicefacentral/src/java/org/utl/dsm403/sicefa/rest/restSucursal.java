...
public class restSucursal {
    ...
    public Response getAll() {
        ...
        try {
            ...
            List<Sucursal> listaSucursal = cu.getAllSucursal();
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Response activarSuc(@QueryParam("idSuc") @DefaultValue("") String idSuc) throws ClassNotFoundException {
        Sucursal s = new Sucursal();
    ...
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    public Response insertarSucursal(@FormParam("s") @DefaultValue("") String sucursal) throws ClassNotFoundException{
        Gson objGson = new Gson();
    ...
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    public Response modificarSucursal(@FormParam("suc") @DefaultValue("") String suc) throws ClassNotFoundException{
        Gson objGson = new Gson();
